...
PAGINATED_HTML1 = """
<article class="cover-only"><section><img src="https://affable-doodad-456.appspot.com/static/images/nq_1.jpg" width="100%" height="100%">
</section><footer><p class='blue text'>Educating the leaders and best</p></footer></article><article class="auto-paginate"><p>UMSI offers advanced research and programs of study from the bachelor's to the doctoral level.
 We address the <em class='yellow'>social and technical aspects</em> of contemporary information use, creating and
 sharing knowledge so that people can use information - with technology - to build a better world.</p>
</article>
<article class="photo"><img src="https://affable-doodad-456.appspot.com/static/images/festifall.jpg" width="100%" height="100%"></article>
<article class="photo"><img src="https://affable-doodad-456.appspot.com/static/images/nq_2.jpg" width="100%" height="100%"></article>
<article class="photo"><img src="https://affable-doodad-456.appspot.com/static/images/iwill.jpg" width="100%" height="100%"><section><footer><div class="overlay-gradient-tall-dark"/><p>Tap again to visit the website!</p></footer></section></article>
"""
...
class MainHandler(webapp2.RequestHandler):
  ...
  def _render_template(self, message=None):
    ...
    try:
      ...
      logging.info('Unable to find UMSI-broadcast contact.')

    timeline_items = self.mirror_service.timeline().list(maxResults=5).execute()
  ...
  def _insert_paginated_item(self):
    ...
    body = {
        'html': PAGINATED_HTML1,
        'notification': {'level': 'DEFAULT'},
        'menuItems': [{
            'action': 'OPEN_URI',
            'payload': 'https://si.umich.edu'
        }]
    }
    # self.mirror_service is initialized in util.auth_required.
  ...
  def _insert_item_with_action(self):
    ...
    body = {
        'creator': {
            'displayName': 'UMSItalkback',
            'id': 'PYTHON_STARTER_PROJECT'
        },
        'text': 'Tell us your favorite SXSW panel so far and why!',
        'notification': {'level': 'DEFAULT'},
  ...
  def _delete_contact(self):
    ...
    return 'Content submission has been disabled.'
